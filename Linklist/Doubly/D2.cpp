// This is the implementation of doubly linkedlist.
#include <iostream>
using namespace std;
class Node
{
...
void Linkdelist ::Create()
{
    Node *nnode, *temp;
    do
    {
        cout << "\n\t Enter a data to create the linked list and press-1 to stop the linked list :";
        nnode = new Node;
        cin >> nnode->no;
        if (nnode->no == -1)
        {
...
void Linkdelist ::Insert_begin()
{
    Node *nnode;
    nnode = new Node;
    cout << "\n\t Enter a new node to inserrt a data at beginnning :";
    cin >> nnode->no;
    nnode->Next = head;
    head = nnode;
    nnode->Next->Prev = nnode;
}
void Linkdelist ::Insert_between()
{
    int data, f = 0;
    Node *nnode;
